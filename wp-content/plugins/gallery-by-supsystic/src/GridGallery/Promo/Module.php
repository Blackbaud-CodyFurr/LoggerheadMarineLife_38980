	...
	public function pointers()
	{
		return array(
			array(
				...
				'title'	 => sprintf('<h3>%s</h3>', $this->translate('Hello! These are the Gallery by Supsystic. ')),
			...
			array(
				...
				'content'   => sprintf('<p>%s</p>', $this->translate('To Create New Gallery select gallery template. You can change template and settings later. Now here four different templates. With PRO version you’ll get more features like Categories, Load More button, Categories, Post Feed (Content) gallery, Polaroid gallery and more. Enter name of the gallery and click “Save”.')),
