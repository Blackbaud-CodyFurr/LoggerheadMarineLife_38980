...
<div id="<?php echo $markup_id; ?>-container">
    ...
    <?php if (isset($data['meta']) && !empty($data['meta']['launcher_label'])) : ?>
        <button type="button" class="btn btn-primary btn-lg btn-blackbaud-flyer<?php echo (!empty($data['meta']['css_class'])) ? ' btn-' . $data['meta']['css_class'] : ''; ?>" data-toggle="modal" data-target="#<?php echo $markup_id; ?>"><?php echo $data['meta']['launcher_label']; ?></button>
    <?php endif; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php endif; ?>
                    <div class="modal-body-content"><?php echo do_shortcode($data['post_content']); ?></div>
