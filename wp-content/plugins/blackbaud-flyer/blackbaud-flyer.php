            ...
            return array(
                ...
                'fields'    => array(
                    array(
                        ...
                        'label'   => __('Featured Image is flyer background', $domain),
                        'default' => '0',
                        'type'    => 'checkbox'
                    ),
                    array(
                    ...
                    array(
                        'slug'    => 'show_once',
                        'label'   => __('Launch automatically only once', $domain),
                        'default' => '0',
                        'type'    => 'checkbox',
                    ...
                    array(
                        'slug'            => 'cookie_expires',
                        'label'           => __('Cookie expires after days:', $domain),
                        'type'            => 'text',
                        'default'         => '30',
                        'attributes'      => array(
                            'class'       => 'form-control',
